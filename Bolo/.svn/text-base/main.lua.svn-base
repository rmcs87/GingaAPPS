--VG's
--arquivo = "C:/Documents and Settings/Ricardo/Desktop/workspaceEuropa/bolo/votos.txt"
arquivo = "votos.txt"
ignore = false
escolha = 0
fator = 8
...
function f2()
	...
	canvas:drawRect('fill', 250-c,i+90,c, 10)
	
	c = (votos[2]/soma)*total
	canvas:attrColor('red')
	canvas:drawRect('fill', 250-c,i+110,c, 10)

	c = (votos[3]/soma)*total
	canvas:attrColor('red')
	canvas:drawRect('fill', 250-c,i+130,c, 10)
