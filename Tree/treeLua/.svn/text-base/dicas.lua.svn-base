...
local icon =  sprite.Sprite:new('imgs/d.png' , 52 , 50 , 52 , 50);
...
function random()
	...
	rand = math.random(1,#textos.dica);
end
...
function draw()
	...
	canvas:drawText(610, 455, rand .. ' de ' .. #textos.dica);
