...
local icon =  sprite.Sprite:new('imgs/t.png' , 52 , 50 , 52 , 50);
...
function draw()
	...
	canvas:drawText(610, 455, rand .. ' de ' .. #textos.trasncricao);
...
function down()
	...
	if rand < #textos.trasncricao then
		rand = rand +1;
	else
		rand = 1;
	end	
