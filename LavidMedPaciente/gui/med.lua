...
function set(esp,let)
	opsConfig.espIndex = esp
	opsConfig.letIndex = let
	ops = guia.getMedicos(opsConfig.espIndex , opsConfig.letIndex)
end
...
function desenha()
	...
	canvas:drawText(opsConfig.x, opsConfig.y, ops[opsConfig.selecionado][1][1])
	canvas:drawText(opsConfig.x, opsConfig.y+(0.5)*config.fonte, ops[opsConfig.selecionado][2][1])
	canvas:drawText(opsConfig.x, opsConfig.y+(0.5)*3*config.fonte, ops[opsConfig.selecionado][3][1])
	canvas:drawText(opsConfig.x, opsConfig.y+(0.5)*2*config.fonte, ops[opsConfig.selecionado][4][1])
...
function selecionar()
	return opsConfig.espIndex, opsConfig.letIndex ,opsConfig.selecionado
end
