...
-- Criado por: Tavares (http://intoweb.blogspot.com/2008/11/criptografia-md5-em-lua.html

local 	_G, tonumber,coroutine, event, assert, pairs, type, string, math, table, io, print, table, canvas, print, setmetatable
	  = _G, tonumber,coroutine, event, assert, pairs, type, string, math, table, io, print, table, canvas, print, setmetatable
